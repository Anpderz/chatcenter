...
=============================================*/
    ...
    =============================================*/
        ...
        =============================================*/
            ...
            echo '<pre>$responseClients ';
            print_r($responseClients);
            echo '</pre>';
        }
    }
...
=============================================*/
    ...
    =============================================*/
        ...
        $idConversation = isset($data->entry[0]->changes[0]->value->statuses[0]->conversation->id)
            ...
            : null;
        echo '<pre>$idConversation ';
        print_r($idConversation);
        echo '</pre>';
    ...
    =============================================*/
        ...
        echo '<pre>$expireConversation ';
        print_r($expireConversation);
        echo '</pre>';
    ...
    =============================================*/
        ...
        =============================================*/
            ...
            if (!$getMessage) {
                echo "No hay mensaje business para este teléfono";
                return;
            }
